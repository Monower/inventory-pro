        ...
        <div className="sidebar bg-white shadow-md flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto py-4 px-2">
                <div className="space-y-1">
                    <a href="#" className="sidebar-link active flex items-center px-4 py-3 rounded-md text-gray-700" onclick="showPage('dashboard', this)">
                        <i className="fas fa-tachometer-alt text-gray-500 w-6 mr-3"></i>
                        <span className="sidebar-text">Dashboard</span>
                    </a>
                    <a href="#" className="sidebar-link flex items-center px-4 py-3 rounded-md text-gray-700" onclick="showPage('products', this)">
                        <i className="fas fa-box text-gray-500 w-6 mr-3"></i>
                        <span className="sidebar-text">Products</span>
                    </a>
                    <a href="#" className="sidebar-link flex items-center px-4 py-3 rounded-md text-gray-700" onclick="showPage('categories', this)">
                        <i className="fas fa-tags text-gray-500 w-6 mr-3"></i>
                        <span className="sidebar-text">Categories</span>
                    </a>
                    <a href="#" className="sidebar-link flex items-center px-4 py-3 rounded-md text-gray-700" onclick="showPage('suppliers', this)">
                        <i className="fas fa-truck text-gray-500 w-6 mr-3"></i>
                        <span className="sidebar-text">Suppliers</span>
                    </a>
                    <a href="#" className="sidebar-link flex items-center px-4 py-3 rounded-md text-gray-700" onclick="showPage('purchases', this)">
                        <i className="fas fa-shopping-cart text-gray-500 w-6 mr-3"></i>
                        <span className="sidebar-text">Purchases</span>
                    </a>
                    <a href="#" className="sidebar-link flex items-center px-4 py-3 rounded-md text-gray-700" onclick="showPage('sales', this)">
                        <i className="fas fa-cash-register text-gray-500 w-6 mr-3"></i>
                        <span className="sidebar-text">Sales</span>
                    </a>
                    <a href="#" className="sidebar-link flex items-center px-4 py-3 rounded-md text-gray-700" onclick="showPage('inventory', this)">
                        <i className="fas fa-warehouse text-gray-500 w-6 mr-3"></i>
                        <span className="sidebar-text">Inventory</span>
                    </a>
                    <a href="#" className="sidebar-link flex items-center px-4 py-3 rounded-md text-gray-700" onclick="showPage('reports', this)">
                    ...
                    <div id="admin-links">
                        <div className="px-4 py-2 mt-4 text-xs font-semibold text-gray-500 uppercase tracking-wider">Administration</div>
                        <a href="#" className="sidebar-link flex items-center px-4 py-3 rounded-md text-gray-700" onclick="showPage('users', this)">
                            <i className="fas fa-users-cog text-gray-500 w-6 mr-3"></i>
                            <span className="sidebar-text">User Management</span>
                        </a>
                        <a href="#" className="sidebar-link flex items-center px-4 py-3 rounded-md text-gray-700" onclick="showPage('settings', this)">
